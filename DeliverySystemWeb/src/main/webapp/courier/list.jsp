            ...
            <div class="panel-body">
                <table class="table table-striped">
                    ...
                    <c:forEach items="${actionBean.courierDTOs}" var="courier">
                        <tr>
                            <td><s:link beanclass="cz.muni.fi.pa165.deliverysystemweb.CourierActionBean" 
                                    event="view"><span class="glyphicon glyphicon-new-window"></span>
                                    <s:param name="id" value="${courier.id}" />
                                </s:link>
                            </td>
                            <td>${courier.firstName}</td>                          </td>
